{
    ...
    ScanChain(chTTV, sample_strTTV, "outputs/plots", "outputs/mc", -1);
    ...
    ScanChain(chTT_lnu, sample_strTT_lnu, "outputs/plots", "outputs/mc",-1);
    ...
    ScanChain(chTT_2l2nu, sample_strTT_2l2nu, "outputs/plots", "outputs/mc",-1);
    ...
    ScanChain(chST_tW, sample_strST_tW, "outputs/plots", "outputs/mc",-1);
    ...
    ScanChain(chWW, sample_strWW, "outputs/plots", "outputs/mc",-1);
    ...
    ScanChain(chOthers, sample_strOthers, "outputs/plots", "outputs/mc",-1);
