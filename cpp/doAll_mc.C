{
    ...
    std::string FILEDIR = "/ceph/cms/store/group/tttt/Worker/usarica/output/Analysis_TTJetRadiation/2023_01_13_tt_bkg_MC";


    // Category TTV
    TChain *chTTV = new TChain("Events");
    std::string sample_strTTV("17_18_TTV");
    //std::string sample_strTTV("All_TTV");
    ...
    std::string sample_strTT_lnu("17_18_TT_lnu");
    //std::string sample_strTT_lnu("All_TT_lnu");
    ...
    std::string sample_strTT_2l2nu("17_18_TT_2l2nu");
    //std::string sample_strTT_2l2nu("All_TT_2l2nu");
    ...
    std::string sample_strST_tW("17_18_ST_tW");
    //std::string sample_strST_tW("All_ST_tW");
    ...
    std::string sample_strWW("17_18_WW");
    //std::string sample_strWW("All_WW");
    ...
    std::string sample_strOthers("17_18_Others");
    //std::string sample_strOthers("All_Others");
